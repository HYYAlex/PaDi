...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='PaDi')


    parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
    parser.add_argument('--model', type=str, required=True, default='PaDi',
                        help='model name, options: [PaDi]')
    ...
    parser.add_argument('--init', type=float, default=-12.0, help='dummy gate init')


    parser.add_argument("--channel_m", type=int, default=4)
    parser.add_argument("--channel_drop", type=float, default=0.5)
    parser.add_argument("--channel_tau", type=float, default=1.0)
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            exp = Exp(args)
            setting = '{}_{}_{}_sl{}_pl{}_dm{}_nh{}_dl{}_df{}_qi{}_dmodel{}_dropout{}_channelm{}_patchlen{}_usechannel{}_epoch{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.seq_len,
